...
<body>
	<div id="contactSection">
		<div class="d-flex justify-content-between align-items-center mb-3">
			...
			<div>
				<form action="contact?action=messageList" method="post"
					style="display: inline;">
					<input type="hidden" name="user_id" value="${sessionScope.user_id}">
					<button type="submit" class="btn btn-secondary">메시지함</button>
				</form>
				<form action="contact?action=logout" method="post"
					style="display: inline;">
		...
		<div class="mb-3">
			<form action="contact?action=findByType" method="post"
				class="row g-3">
				<div class="col-md-4">
					<input type="text" id="searchInput" name="searchInput"
						class="form-control" placeholder="검색할 내용을 입력하세요.">
				</div>
				<div class="col-md-4">
				...
				<c:forEach var="c" items="${contacts }">
					<tr data-id="${c.contact_id}" data-name="${c.name}"
						...
						<td class="action-buttons">
							...
							<form action="contact?action=deleteContact" method="post"
								style="display: inline"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="addContactForm"
						action="contact?action=insertContact" method="post">
						<div class="mb-3">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="editContactForm"
						action="contact?action=updateContact" method="post">
